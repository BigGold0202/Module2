...
bus_test = pd.read_json(r'D:\OneDrive - UW-Madison\Module2\Data_Module2\business_test.json', orient='records', lines=True)
# bus_test.columns ['attributes', 'business_id', 'categories', 'city', 'hours', 'is_open',
# 'latitude', 'longitude', 'name', 'postal_code', 'state']
rev_test = pd.read_json(r'D:\OneDrive - UW-Madison\Module2\Data_Module2\review_train.json', orient='records', lines=True)
